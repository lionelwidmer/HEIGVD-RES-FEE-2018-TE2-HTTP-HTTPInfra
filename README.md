# HEIGVD-RES-FEE-2018-TE2-HTTP/HTTPInfra
...
* This is a **BIG** assignment and you will need a lot of time to complete it. This is the last lab of the semester (it will keep us busy until the end!). You will also have time during the theory lectures to work on it.
* We have prepared webcasts for a big portion of the lab. Following the webcasts and using just a little bit of research from your part, you can get the "base" grade (4.5 pt.).
* To get **additional points**, you will need to do additional research in the documentation by yourself (we are here to help in case you are blocked or something in the assignment is not cleart to you, but we will not give you step-by-step instructions!). To get the extra points, you will also need to be creative (do not expect complete guidelines).
* The grade that you get on this lab will be the grade of your TE2!
* The lab is to be done in **groups of 2 students**. You will learn very important skills and tools, which you will need to next year's courses.
* You may distribute the work among the two members of the group to help you move faster. However, **both members must know, understand and be capable of explaining every step.**
* **Collaboration** with other groups is accepted and encouraged. However, each group must submit a unique work, different enough from the others. 
...
* When you do your **demo**, be prepared so that you can go through the procedure quickly.
* **This assignment includes a report**
...
* You have used a nice looking web template, different from the one shown in the webcasts.
